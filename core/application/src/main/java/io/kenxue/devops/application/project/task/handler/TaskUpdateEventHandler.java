...
import io.kenxue.devops.coreclient.dto.project.task.event.TaskUpdateEvent;
...
@Slf4j
@EventHandler
public class TaskUpdateEventHandler implements EventHandlerI<Response, TaskUpdateEvent> {
    
    public Response execute(TaskUpdateEvent event) {
