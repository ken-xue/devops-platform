package io.kenxue.cicd.application.application.sys.roleofmenu.service;

import io.kenxue.cicd.application.application.sys.roleofmenu.command.query.RoleOfMenuListQryExe;
import io.kenxue.cicd.application.application.sys.roleofmenu.command.query.RoleOfMenuPageQryExe;
import io.kenxue.cicd.coreclient.api.sys.RoleOfMenuAppService;
import io.kenxue.cicd.application.application.sys.roleofmenu.command.RoleOfMenuAddCmdExe;
import io.kenxue.cicd.application.application.sys.roleofmenu.command.RoleOfMenuDeleteCmdExe;
import io.kenxue.cicd.application.application.sys.roleofmenu.command.RoleOfMenuUpdateCmdExe;
import io.kenxue.cicd.application.application.sys.roleofmenu.command.query.RoleOfMenuGetQryExe;
