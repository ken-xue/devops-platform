package io.kenxue.cicd.application.sys.menu.service;

import io.kenxue.cicd.application.sys.menu.command.MenuAddCmdExe;
import io.kenxue.cicd.application.sys.menu.command.MenuDeleteCmdExe;
import io.kenxue.cicd.application.sys.menu.command.MenuUpdateCmdExe;
import io.kenxue.cicd.application.sys.menu.command.query.*;
