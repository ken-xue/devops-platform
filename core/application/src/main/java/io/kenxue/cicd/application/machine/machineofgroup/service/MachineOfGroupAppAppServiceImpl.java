package io.kenxue.cicd.application.application.machine.machineofgroup.service;
...
import io.kenxue.cicd.application.application.machine.machineofgroup.command.MachineOfGroupAddCmdExe;
import io.kenxue.cicd.application.application.machine.machineofgroup.command.MachineOfGroupDeleteCmdExe;
import io.kenxue.cicd.application.application.machine.machineofgroup.command.MachineOfGroupUpdateCmdExe;
import io.kenxue.cicd.application.application.machine.machineofgroup.command.query.MachineOfGroupGetQryExe;
import io.kenxue.cicd.application.application.machine.machineofgroup.command.query.MachineOfGroupListQryExe;
import io.kenxue.cicd.application.application.machine.machineofgroup.command.query.MachineOfGroupPageQryExe;
