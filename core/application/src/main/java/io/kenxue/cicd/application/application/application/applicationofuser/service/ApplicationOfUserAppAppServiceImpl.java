package io.kenxue.cicd.application.application.application.applicationofuser.service;
...
import io.kenxue.cicd.application.application.application.applicationofuser.command.ApplicationOfUserAddCmdExe;
import io.kenxue.cicd.application.application.application.applicationofuser.command.ApplicationOfUserDeleteCmdExe;
import io.kenxue.cicd.application.application.application.applicationofuser.command.ApplicationOfUserUpdateCmdExe;
import io.kenxue.cicd.application.application.application.applicationofuser.command.query.ApplicationOfUserGetQryExe;
import io.kenxue.cicd.application.application.application.applicationofuser.command.query.ApplicationOfUserListQryExe;
import io.kenxue.cicd.application.application.application.applicationofuser.command.query.ApplicationOfUserPageQryExe;
