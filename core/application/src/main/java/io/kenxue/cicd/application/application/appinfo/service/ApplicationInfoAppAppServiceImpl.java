package io.kenxue.cicd.application.application.appinfo.service;

import io.kenxue.cicd.application.application.appinfo.command.ApplicationInfoUpdateCmdExe;
...
import io.kenxue.cicd.application.application.appinfo.command.ApplicationInfoAddCmdExe;
import io.kenxue.cicd.application.application.appinfo.command.ApplicationInfoDeleteCmdExe;
import io.kenxue.cicd.application.application.appinfo.command.query.ApplicationInfoGetQryExe;
import io.kenxue.cicd.application.application.appinfo.command.query.ApplicationInfoListQryExe;
import io.kenxue.cicd.application.application.appinfo.command.query.ApplicationInfoPageQryExe;
