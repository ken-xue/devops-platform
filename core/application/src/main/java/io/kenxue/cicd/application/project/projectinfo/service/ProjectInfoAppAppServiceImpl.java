package io.kenxue.cicd.application.project.projectinfo.service;

import io.kenxue.cicd.application.project.projectinfo.command.query.ProjectInfoGetQryExe;
import io.kenxue.cicd.application.project.projectinfo.command.query.ProjectInfoListQryExe;
import io.kenxue.cicd.application.project.projectinfo.command.query.ProjectInfoPageQryExe;
...
import io.kenxue.cicd.application.project.projectinfo.command.ProjectInfoAddCmdExe;
import io.kenxue.cicd.application.project.projectinfo.command.ProjectInfoDeleteCmdExe;
import io.kenxue.cicd.application.project.projectinfo.command.ProjectInfoUpdateCmdExe;
