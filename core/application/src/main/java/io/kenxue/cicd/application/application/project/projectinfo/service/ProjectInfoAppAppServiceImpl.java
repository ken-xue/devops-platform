package io.kenxue.cicd.application.application.project.projectinfo.service;

import io.kenxue.cicd.coreclient.api.project.ProjectInfoAppService;
import io.kenxue.cicd.coreclient.dto.project.projectinfo.*;
import io.kenxue.cicd.application.application.project.projectinfo.command.ProjectInfoAddCmdExe;
import io.kenxue.cicd.application.application.project.projectinfo.command.ProjectInfoDeleteCmdExe;
import io.kenxue.cicd.application.application.project.projectinfo.command.ProjectInfoUpdateCmdExe;
import io.kenxue.cicd.application.application.project.projectinfo.command.query.ProjectInfoGetQryExe;
import io.kenxue.cicd.application.application.project.projectinfo.command.query.ProjectInfoListQryExe;
import io.kenxue.cicd.application.application.project.projectinfo.command.query.ProjectInfoPageQryExe;
