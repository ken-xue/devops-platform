package io.kenxue.cicd.application.sys.log.service;

import io.kenxue.cicd.application.sys.log.command.LogAddCmdExe;
import io.kenxue.cicd.application.sys.log.command.LogDeleteCmdExe;
import io.kenxue.cicd.application.sys.log.command.LogUpdateCmdExe;
import io.kenxue.cicd.application.sys.log.command.query.LogGetQryExe;
import io.kenxue.cicd.application.sys.log.command.query.LogListQryExe;
import io.kenxue.cicd.application.sys.log.command.query.LogPageQryExe;
