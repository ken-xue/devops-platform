package io.kenxue.cicd.application.application.appconfig.command.query;

import io.kenxue.cicd.application.application.appconfig.assembler.ApplicationConfig2DTOAssembler;
