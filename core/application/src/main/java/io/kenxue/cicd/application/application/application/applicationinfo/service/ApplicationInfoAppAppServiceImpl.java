package io.kenxue.cicd.application.application.application.applicationinfo.service;
...
import io.kenxue.cicd.application.application.application.applicationinfo.command.ApplicationInfoAddCmdExe;
import io.kenxue.cicd.application.application.application.applicationinfo.command.ApplicationInfoDeleteCmdExe;
import io.kenxue.cicd.application.application.application.applicationinfo.command.ApplicationInfoUpdateCmdExe;
import io.kenxue.cicd.application.application.application.applicationinfo.command.query.ApplicationInfoGetQryExe;
import io.kenxue.cicd.application.application.application.applicationinfo.command.query.ApplicationInfoListQryExe;
import io.kenxue.cicd.application.application.application.applicationinfo.command.query.ApplicationInfoPageQryExe;
