package io.kenxue.cicd.application.application.application.appofuser.service;
...
import io.kenxue.cicd.application.application.application.appofuser.command.ApplicationOfUserAddCmdExe;
import io.kenxue.cicd.application.application.application.appofuser.command.ApplicationOfUserDeleteCmdExe;
import io.kenxue.cicd.application.application.application.appofuser.command.ApplicationOfUserUpdateCmdExe;
import io.kenxue.cicd.application.application.application.appofuser.command.query.ApplicationOfUserGetQryExe;
import io.kenxue.cicd.application.application.application.appofuser.command.query.ApplicationOfUserListQryExe;
import io.kenxue.cicd.application.application.application.appofuser.command.query.ApplicationOfUserPageQryExe;
