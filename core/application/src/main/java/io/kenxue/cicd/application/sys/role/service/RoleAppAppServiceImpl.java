package io.kenxue.cicd.application.sys.role.service;
import io.kenxue.cicd.application.sys.role.command.RoleAddCmdExe;
import io.kenxue.cicd.application.sys.role.command.RoleDeleteCmdExe;
import io.kenxue.cicd.application.sys.role.command.RoleUpdateCmdExe;
import io.kenxue.cicd.application.sys.role.command.query.RoleGetQryExe;
import io.kenxue.cicd.application.sys.role.command.query.RoleListQryExe;
import io.kenxue.cicd.application.sys.role.command.query.RolePageQryExe;
