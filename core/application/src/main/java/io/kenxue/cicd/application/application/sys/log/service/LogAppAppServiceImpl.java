package io.kenxue.cicd.application.application.sys.log.service;

import io.kenxue.cicd.application.application.sys.log.command.LogAddCmdExe;
import io.kenxue.cicd.application.application.sys.log.command.LogDeleteCmdExe;
import io.kenxue.cicd.application.application.sys.log.command.LogUpdateCmdExe;
import io.kenxue.cicd.application.application.sys.log.command.query.LogGetQryExe;
import io.kenxue.cicd.application.application.sys.log.command.query.LogListQryExe;
import io.kenxue.cicd.application.application.sys.log.command.query.LogPageQryExe;
import io.kenxue.cicd.coreclient.api.sys.LogAppService;
