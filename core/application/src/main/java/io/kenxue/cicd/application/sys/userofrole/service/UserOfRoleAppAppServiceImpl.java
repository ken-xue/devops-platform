package io.kenxue.cicd.application.sys.userofrole.service;

import io.kenxue.cicd.application.sys.userofrole.command.UserOfRoleAddCmdExe;
import io.kenxue.cicd.application.sys.userofrole.command.UserOfRoleDeleteCmdExe;
import io.kenxue.cicd.application.sys.userofrole.command.UserOfRoleUpdateCmdExe;
import io.kenxue.cicd.application.sys.userofrole.command.query.UserOfRoleGetQryExe;
import io.kenxue.cicd.application.sys.userofrole.command.query.UserOfRoleListQryExe;
import io.kenxue.cicd.application.sys.userofrole.command.query.UserOfRolePageQryExe;
