package io.kenxue.cicd.application.application.application.machineinfo.service;

import io.kenxue.cicd.application.application.application.machineinfo.command.MachineTestConnCmdExe;
...
import io.kenxue.cicd.application.application.application.machineinfo.command.MachineInfoAddCmdExe;
import io.kenxue.cicd.application.application.application.machineinfo.command.MachineInfoDeleteCmdExe;
import io.kenxue.cicd.application.application.application.machineinfo.command.MachineInfoUpdateCmdExe;
import io.kenxue.cicd.application.application.application.machineinfo.command.query.MachineInfoGetQryExe;
import io.kenxue.cicd.application.application.application.machineinfo.command.query.MachineInfoListQryExe;
import io.kenxue.cicd.application.application.application.machineinfo.command.query.MachineInfoPageQryExe;
