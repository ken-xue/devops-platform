...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='项目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project_info` VALUES (1,'07c697c30f5f4d6280e34a6b1d46af42','云原生一期','26220d63bfd345dabb2f114287965313','云原生一期','admin','admin','2022-02-19 04:10:02','2022-02-19 04:10:02','0'),(2,'be408f98e96249a6a930a560cf2514b4','系统中台化一期','9df9de08354f456c97fae0cdb3df214f','系统中台化一期系统中台化一期系统中台化一期系统中台化一期','admin','admin','2022-02-19 06:42:06','2022-02-19 06:42:06','0');
...
INSERT INTO `sys_captcha` VALUES ('54f4693a-eb84-430e-8a3b-dc02f4e13773','4fncm','2022-02-19 08:37:07');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8mb4 COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-02-19 17:59:44
