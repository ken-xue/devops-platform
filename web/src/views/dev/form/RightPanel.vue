<template>
  <div class="right-board">
    <div style="margin: 0 10px 0 10px">
      <el-button icon="el-icon-download" style="width: 30%" type="text" @click="this.$parent.download">导出vue文件</el-button>
      <el-button class="delete-btn" style="width: 30%" icon="el-icon-delete" type="text" @click="this.$parent.empty">清空</el-button>
      <el-button class="copy-btn-main" style="width: 30%" icon="el-icon-document-copy" type="text" @click="this.$parent.copy">复制代码</el-button>
    </div>
...
import TreeNodeDialog from '@/views/dev/form/TreeNodeDialog'
